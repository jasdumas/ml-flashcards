...
- Download images of the flashcards from `media_url` column append the file name from the tweet text description and save into a folder:
```{r}
...
At the end of this process you can view all of the #machinelearningflashcards in one place! Thanks to Chris Albon for his work on this, and I'm looking forward to re-running this script to gain knowledge on new #machinelearningflashcards that are developed in the future!
